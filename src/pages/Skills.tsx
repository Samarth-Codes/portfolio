...
const skills: Skill[] = [
    ...
    { id: 6, name: "Tailwind", level: 88, category: "Frontend", icon: "💨" },

    // Backend
    { id: 7, name: "Node.js", level: 85, category: "Backend", icon: "🟢" },
    { id: 8, name: "Express", level: 80, category: "Backend", icon: "🚀" },
    { id: 9, name: "Python", level: 90, category: "Backend", icon: "🐍" },
    { id: 10, name: "Java", level: 85, category: "Backend", icon: "☕" },
    { id: 11, name: "C", level: 80, category: "Backend", icon: "🔧" },

    // AI/ML
    { id: 12, name: "PyTorch", level: 85, category: "AI/ML", icon: "🔥" },
    { id: 13, name: "Scikit-learn", level: 80, category: "AI/ML", icon: "🧠" },
    { id: 14, name: "OpenAI API", level: 85, category: "AI/ML", icon: "🤖" },
    { id: 15, name: "Gemini API", level: 80, category: "AI/ML", icon: "💎" },

    // DevOps & Cloud
    { id: 16, name: "Docker", level: 80, category: "DevOps", icon: "🐳" },
    { id: 17, name: "Git", level: 90, category: "DevOps", icon: "📝" },
    { id: 18, name: "GitHub", level: 90, category: "DevOps", icon: "🐙" },
    { id: 19, name: "Google Cloud", level: 75, category: "DevOps", icon: "☁️" },
    ...
    // Blockchain
    { id: 23, name: "Solidity", level: 80, category: "Blockchain", icon: "🔗" },
    { id: 24, name: "Web3.js", level: 85, category: "Blockchain", icon: "🌐" },
    { id: 25, name: "Ethereum", level: 80, category: "Blockchain", icon: "⚡" }
];
